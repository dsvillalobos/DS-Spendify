...
function addExpense() {
  ...
  if (localStorage.getItem("basicExpenses") === null) {
    expenses = [];
  } else {
    expenses = JSON.parse(localStorage.getItem("basicExpenses"));
  }
  ...
  //Store Expenses
  localStorage.setItem("basicExpenses", JSON.stringify(expenses));
...
updateExpenseList(expenses);
localStorage.setItem("basicExpensesTOT", totalAmount);

...
placeholderExpenseName.setAttribute("placeholder", "E.g. Netflix");
const amountPlaceholder = document.getElementById("amount");
amountPlaceholder.setAttribute("placeholder", "E.g. 12");
...
function addExpense() {
  ...
  if (localStorage.getItem("entertainment") === null) {
    ...
    expenses = JSON.parse(localStorage.getItem("entertainment"));
  }
  ...
  //Store Expenses
  localStorage.setItem("entertainment", JSON.stringify(expenses));
...
updateExpenseList(expenses);
localStorage.setItem("entertainmentTOT", totalAmount);

...
placeholderExpenseName.setAttribute("placeholder", "E.g. Medical Bills");
...
function addExpense() {
  ...
  if (localStorage.getItem("health") === null) {
    ...
    expenses = JSON.parse(localStorage.getItem("health"));
  }
  ...
  //Store Expenses
  localStorage.setItem("health", JSON.stringify(expenses));
...
updateExpenseList(expenses);
localStorage.setItem("healthTOT", totalAmount);

...
placeholderExpenseName.setAttribute("placeholder", "E.g. Veterinary Visit");
const amountPlaceholder = document.getElementById("amount");
amountPlaceholder.setAttribute("placeholder", "E.g. 75");
...
function addExpense() {
  ...
  if (localStorage.getItem("petExpenses") === null) {
    expenses = [];
  } else {
    expenses = JSON.parse(localStorage.getItem("petExpenses"));
  }
...
updateExpenseList(expenses);
localStorage.setItem("petExpensesTOT", totalAmount);

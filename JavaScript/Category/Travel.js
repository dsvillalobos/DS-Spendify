...
placeholderExpenseName.setAttribute("placeholder", "E.g. Flight Tickets");
const amountPlaceholder = document.getElementById("amount");
amountPlaceholder.setAttribute("placeholder", "E.g. 500");
...
updateExpenseList(expenses);
localStorage.setItem("travelTOT", totalAmount);

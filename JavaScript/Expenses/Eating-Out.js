...
const expensesContainer = document.getElementById("eatingOutExpensesContainer");

let expenses;

function getEatingOutExpenses() {
  if (localStorage.getItem("expenses") === null) {
    ...
    for (let i = 0; i < expenses.length; i++) {
      if (expenses[i].expenseCategory == "Eating Out") {
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-3 d-flex justify-content-end">
                <button class="btn btn-danger btn-sm" onclick="deleteEatingOutExpense(${i})">
...
function deleteEatingOutExpense(index) {
  expenses.splice(index, 1);
  localStorage.setItem("expenses", JSON.stringify(expenses));
  getEatingOutExpenses();
}

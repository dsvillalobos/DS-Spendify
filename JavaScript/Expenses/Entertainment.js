...
const expensesContainer = document.getElementById(
  "entertainmentExpensesContainer"
);

let expenses;

function getEntertainmentExpenses() {
  if (localStorage.getItem("expenses") === null) {
    ...
    for (let i = 0; i < expenses.length; i++) {
      if (expenses[i].expenseCategory == "Entertainment") {
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-3 d-flex justify-content-end">
                <button class="btn btn-danger btn-sm" onclick="deleteEntertainmentExpense(${i})">
...
function deleteEntertainmentExpense(index) {

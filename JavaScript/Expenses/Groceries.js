...
const expensesContainer = document.getElementById("groceriesExpensesContainer");

let expenses;

function getGroceriesExpenses() {
  if (localStorage.getItem("expenses") === null) {
    ...
    for (let i = 0; i < expenses.length; i++) {
      if (expenses[i].expenseCategory == "Groceries") {
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-3 d-flex justify-content-end">
                <button class="btn btn-danger btn-sm" onclick="deleteGroceriesExpense(${i})">
...
function deleteGroceriesExpense(index) {
  expenses.splice(index, 1);
  localStorage.setItem("expenses", JSON.stringify(expenses));
  getGroceriesExpenses();
}

...
const expensesContainer = document.getElementById(
  "healthAndFitnessExpensesContainer"
);

let expenses;

function getHealthAndFitnessExpenses() {
  if (localStorage.getItem("expenses") === null) {
    ...
    for (let i = 0; i < expenses.length; i++) {
      if (expenses[i].expenseCategory == "Health and Fitness") {
          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-3 d-flex justify-content-end">
                <button class="btn btn-danger btn-sm" onclick="deleteHealthAndFitnessExpense(${i})">
...
function deleteHealthAndFitnessExpense(index) {
  expenses.splice(index, 1);
  localStorage.setItem("expenses", JSON.stringify(expenses));
  getHealthAndFitnessExpenses();
}
